...
export function IdeFilesPanel({
  ...
  function startRename(filename: string, isMain: boolean) {
    if (isMain) return
        ...
        <div className="flex h-full min-h-0 flex-col p-2">
          ...
          <ul className="min-h-0 flex-1 space-y-0.5 overflow-y-auto">
            {files.map((file) => {
              ...
              const renaming = renamingFilename === file.filename
              return (
                <li key={file.filename} className="group/file">
                  <div
                    className={cn(
                  ...
                  >
                    {renaming ? (
                      ...
                      <button
                        ...
                        onDoubleClick={() => startRename(file.filename, file.is_main)}
                        className={cn(
                      ...
                      <div className="mr-0.5 flex shrink-0 items-center">
                        <button
                          ...
                          onClick={(e) => {
                            ...
                            startRename(file.filename, false)
                          }}
                          className={cn(
